...
import com.example.fac.databinding.ActivitySem5Binding;
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                Log.d("SEM5_DEBUG", "Document Data - Subject: " + subjectName + ", Name: " + name + ", URL: " + url); // Log each document's data
                            ...
                            Log.w("SEM5_DEBUG", "Error getting documents from " + subjectName, task.getException());
                            Toast.makeText(Sem5.this, "Error fetching documents from " + subjectName, Toast.LENGTH_SHORT).show();
                        }

                        subcollectionQueriesCompleted[0]++;
                        if (subcollectionQueriesCompleted[0] == totalSubcollections) {
                            Log.d("SEM5_DEBUG", "All subcollection queries completed. Total documents in list: " + documentList.size()); // Log final list size
